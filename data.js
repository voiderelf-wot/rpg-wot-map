...
const LOCATIONS = [
  {
    ...
    npcs: [
      ...
      { name: "Callan Forjaforte", role: "Ferreiro · loja de armas", type: "shop", desc: "Homem musculoso de barba negra cheia, natural de Illian. Vendeu armas básicas ao grupo com a carta de crédito de Serenya.",
        items: [
          { name: "Adaga", price: "2 PO" },
          { name: "Espada curta", price: "10 PO" },
          { name: "Espada longa", price: "15 PO" },
          { name: "Arco curto", price: "25 PO" },
          { name: "Arco longo", price: "50 PO" },
          { name: "Armadura de couro", price: "10 PO" },
          { name: "Camisão de malha", price: "50 PO" },
          { name: "Cota de malha", price: "75 PO" },
          { name: "Escudo", price: "10 PO" }
        ] },
      { name: "Mara al'Dene", role: "Herbalista · poções de cura", type: "shop", desc: "Baixa, gentil, cheirando a ervas frescas, natural de Tear. Vendeu poções de cura ao grupo.",
        items: [
          { name: "Poção de cura", price: "50 PO" },
          { name: "Antídoto", price: "50 PO" },
          { name: "Kit de cura (10 usos)", price: "5 PO" },
          { name: "Rações (1 dia)", price: "5 PP" }
        ] },
      { name: "Vandor Merrilin", role: "Comerciante · equipamento geral", type: "shop", desc: "Elegante e astuto, natural de Caemlyn. Vendeu equipamento geral ao grupo.",
        items: [
          { name: "Mochila", price: "2 PO" },
          { name: "Corda (50 pés, cânhamo)", price: "1 PO" },
          { name: "Corda (50 pés, seda)", price: "10 PO" },
          { name: "Tocha", price: "1 PC" },
          { name: "Lanterna com óleo", price: "5 PP + 1 PP/hora" },
          { name: "Ferramentas de ladrão", price: "25 PO" },
          { name: "Pergaminho e tinta", price: "1 PO" },
          { name: "Sela comum", price: "10 PO" }
        ] },
